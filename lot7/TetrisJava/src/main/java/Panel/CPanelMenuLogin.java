...
/**
 * CPanelMenuLogin class - Login screen panel with input fields and buttons.
 */
public class CPanelMenuLogin extends JPanel {
    ...
    public CPanelMenuLogin(Mavenproject1 mainInstance, MainFrame frame) {
        this.frame = frame;
        ...
        btnRegister = new ButtonMenu(DIRECTORYPROJECT + "\\src\\main\\java\\Ressources\\Buttons\\buttonRegister.png",
        ...
        btnValidate = new ButtonMenu(DIRECTORYPROJECT + "\\src\\main\\java\\Ressources\\Buttons\\buttonValidate.png",
                e -> {
            try {
                loginSession(textFieldPseudo.getText(), String.valueOf(textFieldPassword.getPassword()));
            } catch (SQLException ex) {
                Logger.getLogger(CPanelMenuLogin.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        btnBack = new ButtonMenu(DIRECTORYPROJECT + "\\src\\main\\java\\Ressources\\Buttons\\buttonBack.png",
