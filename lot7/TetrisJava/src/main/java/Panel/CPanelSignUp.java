...
/**
 * CPanelSignUp class - Panel for account registration.
 */
public class CPanelSignUp extends JPanel {
    ...
    public CPanelSignUp(MainFrame frame) {
        this.frame = frame;
        ...
        btnLogin = new ButtonMenu(DIRECTORYPROJECT + "\\src\\main\\java\\Ressources\\Buttons\\buttonLogin.png",
        ...
        btnValidate = new ButtonMenu(DIRECTORYPROJECT + "\\src\\main\\java\\Ressources\\Buttons\\buttonValidate.png",
            ...
            try {
                ...
                Logger.getLogger(CPanelSignUp.class.getName()).log(Level.SEVERE, null, ex);
