...
public class CPanelMenu extends JPanel implements EventListener {
    ...
    public CPanelMenu(Mavenproject1 mainInstance, MainFrame frame) {
       ...
       this.setLayout(new GridBagLayout()); // Utilisation du GridBagLayout
        ...
        btnGuest = new ButtonMenu(DIRECTORYPROJECT + "\\src\\main\\java\\Ressources\\Buttons\\buttonGuest.png",
                e -> frame.addNewPanelGame(), 4, frame.getWidth(), frame.getHeight(), 50);
        
        btnAI = new ButtonMenu(DIRECTORYPROJECT + "\\src\\main\\java\\Ressources\\Buttons\\buttonIA.png",
                e -> {
            try {
        ...
        btnGpt = new ButtonMenu(DIRECTORYPROJECT + "\\src\\main\\java\\Ressources\\Buttons\\buttonGPT.png",
                e -> {
            try {
                frame.addNewPanelOpenAI();
            } catch (IOException ex) {
